...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView generatedValue= findViewById(R.id.generatedValue);
        ...
        generate.setOnClickListener(new View.OnClickListener() {    //set onclick listen when generate button is pressed
            ...
            public void onClick(View v) {
                ...
                if (num == 0)
                {
                    generatedValue.setText(str1);
                }
                if (num == 1)
                {
                    generatedValue.setText(str2);
                }
                if (num == 2)
                {
                    generatedValue.setText(str3);
                }
                if (num == 3)
                {
                    generatedValue.setText(str4);
                }
                if (num == 4)
                {
                    generatedValue.setText(str5);
                }
            }
        });
    }
